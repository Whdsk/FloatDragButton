...
public class FloatTouchListener implements View.OnTouchListener {
    ...
    private boolean adjustMarginParams(View v, MotionEvent event) {
        ...
        int aaa=mFloatView.getWidth();
        int dddd=mFloatView.getHeight();
        //左上角位置
